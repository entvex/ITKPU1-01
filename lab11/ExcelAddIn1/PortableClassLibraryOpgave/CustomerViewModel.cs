...
using PortableClassLibraryOpgaveSimpleMVVM.Model;
using PortableClassLibraryOpgaveSimpleMVVM.ViewModel;

namespace PortableClassLibraryOpgaveSimpleMVVM.ViewModel
{
